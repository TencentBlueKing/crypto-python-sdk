...
class BaseInterceptor:
    """Provide no-op hooks around encryption and decryption operations."""

    @classmethod
    def before_encrypt(cls, plaintext: str, **kwargs: object) -> str:
        return plaintext
    ...
    @classmethod
    def after_decrypt(cls, plaintext: str, **kwargs: object) -> str:
        return plaintext
